...
class EditAd extends StatefulWidget {
  ...
  String documentId;
  int indexDocument;
  EditAd({this.documentId, this.indexDocument});
  @override
  _EditAdState createState() => _EditAdState(documentId: documentId);
}
...
class _EditAdState extends State<EditAd> {
  String documentId;
  int indexDocument;
  _EditAdState({this.documentId, this.indexDocument});
  ...
  getDocumentValue()async{
    ...
    setState(() {
      showSlider=true;
      nameController=TextEditingController(text:documentsAds['name']);
      descriptionController=TextEditingController(text:documentsAds['description']);
      phoneController=TextEditingController(text:documentsAds['phone'].toString());
      priceController=TextEditingController(text:documentsAds['price'].toString());
      category = documentsAds['category'];
      category2 = documentsAds['department'];
      urlImages = documentsAds['imagesUrl'];
  ...
  Future<Null> Alert(BuildContext context){
    return showDialog(context:context ,barrierDismissible: false,builder: (BuildContext context){
      return AlertDialog(
        title: Text('حذف الصور',textAlign: TextAlign.right,
          style: TextStyle(
            fontSize: 22,
            fontFamily: 'AmiriQuran',
            height: 1.5),),
        content: SingleChildScrollView(
          child: ListBody(
            children: <Widget>[
              Text('هل تريد حذف الصور القديمة وإظافة صور جديدة؟',style: TextStyle(
                  fontSize: 15,
                  fontFamily: 'AmiriQuran',
                  height: 1.4),)
            ],
        ...
        actions: <Widget>[
          FlatButton(onPressed: (){Navigator.of(context).pop();}, child:Text('لا',textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: 22,
              fontFamily: 'AmiriQuran',
              color: Colors.white,
          ...
          FlatButton(onPressed: (){
            deleteImage();
            Navigator.of(context).pop();
          }, child:Text('تأكيد',textAlign: TextAlign.center,
            style: TextStyle(
              fontSize: 22,
              fontFamily: 'AmiriQuran',
              color: Colors.white,
